...
personalities = {
  ...
  Always ask a follow-up question to check understanding. Give me over all question in a consize manner."""
...
def study_assistant(question , persona):
  ...
  response = client.models.generate_content(
       ...
       config= types.GenerateContentConfig( systemInstruction = system_prompt , temperature=0.4 , max_output_tokens= 2000),
       contents= question
  )
